<!-- @if (Route::has('login'))
        ...
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img  src="{{ asset('img/logo8.png') }}" alt="Logo"></a>
                <strong><a href="index.html"><img  src="{{ asset('img/icon.png') }}" alt="Logo"></a></strong>
            </div>
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a title="Landing Page" href="{{url('admins/')}}" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Admin</span></a>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Add Professor" href="{{url('talents/')}}"><span class="mini-sub-pro">Talents</span></a></li>
                                <li><a title="Edit Professor" href="{{url('investors/')}}"><span class="mini-sub-pro">Investors</span></a></li>                               
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="all-students.html" aria-expanded="false"><span class="educate-icon educate-student icon-wrap"></span> <span class="mini-click-non">Components</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                        ...
                        <li>
                            <a class="has-arrow" href="all-courses.html" aria-expanded="false"><span class="educate-icon educate-course icon-wrap"></span> <span class="mini-click-non">Front End</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Courses" href="all-courses.html"><span class="mini-sub-pro">Talent Header</span></a></li>
                                <li><a title="Add Courses" href="add-course.html"><span class="mini-sub-pro">Sponsor Header</span></a></li>
                                <li><a title="Edit Courses" href="edit-course.html"><span class="mini-sub-pro">Header Pictures</span></a></li>
                                <li><a title="Courses Profile" href="course-info.html"><span class="mini-sub-pro">Ads</span></a></li>
                                <li><a title="Product Payment" href="course-payment.html"><span class="mini-sub-pro">Share us</span></a></li>
                            </ul>
                        </li>
                        <li>
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                ...
                                                <li class="nav-item"><a href="{{ url('talents/') }}" class="nav-link">Talent</a>
                                                </li>
												<li class="nav-item"><a href="{{ url('partners/') }}" class="nav-link">Activities</a></li>
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{ asset('admin-asset/img/contact/1.jpg') }}" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{ asset('admin-asset/img/contact/4.jpg') }}" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{ asset('admin-asset/img/contact/3.jpg') }}" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="{{ asset('admin-asset/img/contact/2.jpg') }}" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
